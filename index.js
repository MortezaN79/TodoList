...
function addTask(todo, id, done, trash) {
    ...
    const item = `<li class="item">
            <img class="todo-check--box ${DONE}" onclick="taskDone(this)" id = ${id} src="https://img.icons8.com/ios/24/000000/circled.png" alt="circle"/>
            <span class="todo-check--text ${LINE}"> ${todo} </span>
            <img class = "close--task" onclick="taskRemove(this)" id = ${id}  src="https://img.icons8.com/ios/24/000000/multiply.png" alt ="close_btn"/>
